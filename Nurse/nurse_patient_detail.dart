      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Row(
              children: [
                Expanded(child: _buildTab(0, 'Allergies')),
                Expanded(child: _buildTab(1, 'Treatment Plans')),
                Expanded(child: _buildTab(2, 'Notes')),
                Expanded(child: _buildTab(3, 'Billing & Insurance Info')),
              ],
            ),
            // Main content
            Expanded(
