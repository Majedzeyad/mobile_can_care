...
class NurseGroupChatsList extends StatefulWidget {
  const NurseGroupChatsList({super.key});

  @override
  State<NurseGroupChatsList> createState() => _NurseGroupChatsListState();
}

class _NurseGroupChatsListState extends State<NurseGroupChatsList> {
  ...
  Future<void> _loadGroups() async {
    try {
      ...
      print('[Nurse Group Chats List] Error loading groups: $e');
      if (mounted) {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => NurseChatScreen(groupId: group.id),
          ),
        );
      },
