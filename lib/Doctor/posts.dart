  ...
  Future<void> _loadPosts() async {
    try {
      ...
      for (var post in posts) {
        print('[Posts] Post ${post.id}: image="${post.image}", image is null: ${post.image == null}, image isEmpty: ${post.image?.isEmpty ?? true}');
      }
          ...
          if (post.image != null && post.image!.isNotEmpty) ...[
            Builder(
              builder: (context) {
                ...
                print('[Posts] Rendering image for post ${post.id}: "$imageUrl"');
                  ...
                  return FutureBuilder<String?>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasError || !snapshot.hasData || snapshot.data == null) {
                        print('[Posts] Error getting download URL: ${snapshot.error}');
