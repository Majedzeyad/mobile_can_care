...
class PatientGroupChatsList extends StatefulWidget {
  const PatientGroupChatsList({super.key});

  @override
  State<PatientGroupChatsList> createState() => _PatientGroupChatsListState();
}

class _PatientGroupChatsListState extends State<PatientGroupChatsList> {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('خطأ في تحميل المحادثات: $e')));
      }
    }
  }
  ...
  Widget _buildGroupCard(
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => ChatScreen(groupId: group.id)),
        );
      },
